...
#against sending IP address. Don't need to match.	conf.checkIPaddr = False 
...
#Source port = 68 (DHCP / BOOTP Client)#Destination port = 67 (DHCP / BOOTP Server)
...
#Send packet out of eth0 and loop the packetsendp(dhcp_discover,iface='eth0',loop=1,verbose=1) 
#Credits:
